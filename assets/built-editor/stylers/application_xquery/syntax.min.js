...
*/
define("orion/editor/stylers/application_xquery/syntax",["orion/editor/stylers/lib/syntax"],function(c){var b="zero-digit xquery window where when version variable validate unordered union typeswitch type tumbling try treat to then text switch strip strict start stable some sliding self schema-element schema-attribute schema satisfies return processing-instruction previous preserve preceding-sibling preceding percent per-mille pattern-separator parent ordering order or option only of node no-preserve no-inherit next ne NaN namespace-node namespace module mod minus-sign lt let least le lax item is intersect instance inherit infinity in import if idiv gt grouping-separator group greatest ge function for following-sibling following external except every eq end encoding empty-sequence empty else element document-node div digit descending descendant-or-self descendant default declare decimal-separator decimal-format count copy-namespaces context construction comment collation child catch castable cast case by boundary-space base-uri attribute at ascending as and ancestor-or-self ancestor allowing".split(" "),
a=[];a.push.apply(a,c.grammars);a.push({id:"orion.xquery",contentTypes:["application/xquery"],patterns:[{include:"#comment"},{include:"#variable"},{include:"#multiLineDoubleQuote"},{include:"#multiLineSingleQuote"},{include:"orion.xml#tag"},{include:"orion.lib#brace_open"},{include:"orion.lib#brace_close"},{include:"orion.lib#bracket_open"},{include:"orion.lib#bracket_close"},{include:"orion.lib#parenthesis_open"},{include:"orion.lib#parenthesis_close"},{match:"\\b(?:"+b.join("|")+")\\b",name:"keyword.operator.js"}],
